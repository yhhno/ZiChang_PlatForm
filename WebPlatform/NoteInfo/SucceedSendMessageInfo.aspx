<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SucceedSendMessageInfo.aspx.cs"
    Inherits="NoteInfo_SucceedSendMessageInfo" %>
                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%" border="0">
                    ...
                    <tr>
                        <td valign="top" style="height: 20px" colspan="3">
                            <asp:GridView ID="gdv_LoadWeight" runat="server" DataKeyNames="Rowno" AutoGenerateColumns="False"
                                Width="100%" BorderStyle="None" 
                                onrowdatabound="gdv_LoadWeight_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="SucceedDate" HeaderText="发送时间"  >
                    ...
                    <tr>
                        <td class="page" colspan="3">
                            <webdiyer:AspNetPager AlwaysShow="true" ID="anp_LoadWeight" runat="server" PageSize="20"
                                ShowCustomInfoSection="Left" OnPageChanging="anp_LoadWeight_PageChanging" FirstPageText="第一页"
