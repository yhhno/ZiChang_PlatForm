<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReceiveMessageInfo.aspx.cs"
    Inherits="NoteInfo_ReceiveMessageInfo" %>
                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%" border="0">
                    ...
                    <tr>
                        <td valign="top" style="height: 20px" colspan="3">
                            <asp:GridView ID="gdv_ReadySendMessage" runat="server" DataKeyNames="RMID" AutoGenerateColumns="False"
                                Width="100%" BorderStyle="None" 
                                onrowdatabound="gdv_ReadySendMessage_RowDataBound">
                                <Columns>
                    ...
                    <tr>
                        <td class="page" colspan="3">
                            <tr>
                                <td class="page" colspan="3">
                                    <webdiyer:AspNetPager AlwaysShow="true" ID="anp_ReceiveMessage" runat="server" PageSize="20"
                                        ShowCustomInfoSection="Left" OnPageChanging="anp_ReceiveMessage_PageChanging" FirstPageText="第一页"
