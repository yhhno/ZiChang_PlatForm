...
function WebCalendar() //初始化日历的设置
{
    ...
    this.format     = "yyyy-mm-dd"; //回传日期的格式    this.timeShow   = null;     //是否返回时间
    this.drag       = true;         //是否允许拖动
    this.darkColor  = "#D6CFCE";    //控件的暗色
    this.lightColor = "#FFFFFF";    //日历控件的亮色
    this.btnBgColor = "#D1D1D1";    //日历控件的按钮背景色
    this.wordColor  = "#000040";    //日历控件的文字颜色
    this.wordDark   = "#DCDCDC";    //日历控件的暗文字颜色
    this.dayBgColor = "#FFFACD";    //日历日期数字背景色
    this.todayColor = "#D1EEEE";    //今天在日历上的标示背景色
    this.DarkBorder = "#FFE4C4";    //日历日期显示的立体表达色
}   var WebCalendar = new WebCalendar();

function calendar_time() //主调函数
{
