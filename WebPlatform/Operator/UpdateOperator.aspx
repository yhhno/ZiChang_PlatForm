<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateOperator.aspx.cs" Inherits="Operator_UpdateOperator" %>
       ...
       <ContentTemplate>
        <table width="600px" align="center">
            ...
            <td align="right" id="tdTypeCode" runat="server" visible="false">
                <asp:Label ID="lblTypeCode" runat="server" Text=""></asp:Label>
            </td>
            <td>
                <asp:DropDownList ID="ddl_TypeCode" runat="server" Width="157px">
                </asp:DropDownList>
                <span class="required" id="spanStar" runat="server">*</span>
            </td>
            </td>
        </tr>
            <tr>
            ...
            <tr>
                <td colspan="4" align="center" style="height: 40px" valign="bottom">
