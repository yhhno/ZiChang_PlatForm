...
namespace IndustryPlatform.DBUtility
{
    public class CommonMethod
    {
        ...
        public static string RepChar(string strField)
        {
        ...
        public static void FileDownLoad(string filepath)
        {
            ...
            System.Web.HttpContext.Current.Response.AddHeader("Content-Disposition", "attachment;FileName=" + HttpUtility.UrlEncode("temp" + hz, System.Text.Encoding.UTF8));
